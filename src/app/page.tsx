    ...
    <div className="w-full overflow-x-hidden bg-white">
      ...
      <header className="relative overflow-hidden bg-[linear-gradient(180deg,#fff5ee_0%,#fffaf6_60%,#ffffff_100%)] px-8 pt-[72px] pb-16">
        ...
        <div data-reveal data-reveal-delay="420" className="relative mx-auto mt-[52px] max-w-[1020px]">
          <div className="overflow-hidden rounded-t-[18px] border border-b-0 border-[#eadfd5] bg-white shadow-[0_40px_80px_-32px_rgba(92,28,0,0.32)]">
            ...
            <div className="flex h-[420px] bg-white">
              ...
              <div className="flex min-w-0 flex-1 flex-col">
                <div className="flex flex-1 flex-col gap-3.5 overflow-hidden px-6 py-5">
                  <div className="flex justify-end">
                    <span className="max-w-[75%] rounded-[14px_14px_4px_14px] border border-[#ffe5d3] bg-[#fff5ee] px-3.5 py-2.5 text-[13px] text-[#5c1c00]">
                      Berapa tarif PPh Badan &amp; dasar hukumnya?
                    </span>
                  </div>
                  <div className="flex items-start gap-2.5">
                    <span className="flex h-7 w-7 flex-none items-center justify-center rounded-lg bg-[rgba(255,80,1,0.10)] text-[#ff5001]">
                    ...
                    <div className="flex flex-1 flex-col gap-2.5">
                      <span className="text-[13px] leading-[1.55] text-[#3f2a1c]">
                        Tarif PPh Badan saat ini{" "}
                        <b className="text-[#5c1c00]">22% dari Penghasilan Kena Pajak</b>
                        <span className="mx-0.5 inline-flex h-[15px] min-w-[15px] items-center justify-center rounded bg-[rgba(255,80,1,0.12)] px-1 align-[1px] text-[10px] font-bold text-[#ff5001]">1</span>
                        ; untuk Perseroan Terbuka tersedia tarif{" "}
                        <b className="text-[#5c1c00]">19%</b>
                        <span className="mx-0.5 inline-flex h-[15px] min-w-[15px] items-center justify-center rounded bg-[rgba(255,80,1,0.12)] px-1 align-[1px] text-[10px] font-bold text-[#ff5001]">2</span>
                        .
                      </span>
                      <div className="flex items-center gap-[9px] rounded-[10px] border border-[#e7e9ee] px-[11px] py-[9px]">
                        <span className="inline-flex h-[19px] min-w-[26px] items-center justify-center rounded-[5px] border border-[#ffe5d3] bg-[#fff5ee] px-1.5 text-[10px] font-extrabold text-[#b83800]">UU</span>
                        <span className="flex-1 text-[12px] font-bold text-[#5c1c00]">UU No. 7 Tahun 2021 (HPP)</span>
                      ...
                      <div className="flex items-center gap-[7px] rounded-[9px] border border-[#eceae6] bg-[#f9f8f6] px-2.5 py-[7px]">
                        <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="#a89a8c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-none">
                          <circle cx="12" cy="12" r="10" />
                          <path d="M12 16v-4" />
                          <path d="M12 8h.01" />
                        </svg>
                        <span className="text-[10.5px] leading-[1.4] text-[#8a7d70]">
                          Informasional · tidak menggantikan pakar bersertifikat
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="px-6 pt-3 pb-4">
                  <div className="flex items-center gap-2 rounded-[13px] border border-[#e2dcd4] py-[9px] pr-[9px] pl-3.5 shadow-[0_2px_8px_rgba(92,28,0,0.04)]">
                    <span className="flex-1 text-[12.5px] text-[#bcae9f]">
                      Tanya soal PPh, PPN, faktur pajak…
                    </span>
